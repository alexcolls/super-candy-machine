...
```
ts-node ./metaplex/js/packagescli/src/candy-machine-cli.ts upload ./nft-assets -e devnet -k ~/key.json
```
...
metaplex upload ./png-assets -e devnet -k ~/key.json
metaplex verify ./nft-assets -e devnet -k ~/key.json